"""URL patterns for the Schools & Formations referential — Story 4.1 / 4.2 / 4.5."""
...
urlpatterns = [
    ...
    # Story 4.3 / 4.5 — parcours list per profession
    path("metiers/<slug:slug>/parcours/", ParcoursListView.as_view(), name="parcours-list"),
]
