...
export const PASSIONS_CATEGORIES: readonly PassionCategory[] = [
  {
    ...
    aliases: ["bio", "biologie", "physique", "chimie", "nature"],
  },
  {
    id: "tech-code",
    label: "Tech & code",
    aliases: ["code", "informatique", "dev", "programmation", "ia"],
  },
  {
    id: "arts-creation",
    label: "Arts & création",
    aliases: ["dessin", "peinture", "art", "design"],
  },
  { id: "sport-corps", label: "Sport & corps", aliases: ["sport", "fitness", "danse", "yoga"] },
  {
    id: "aider-autres",
    label: "Aider les autres",
    aliases: ["humanitaire", "social", "associatif", "bénévolat"],
  },
  ...
  { id: "cinema-series", label: "Cinéma & séries", aliases: ["ciné", "film", "série", "netflix"] },
  {
    ...
    aliases: ["livre", "roman", "écrire", "poésie"],
  },
  {
    id: "voyage-cultures",
    label: "Voyage & cultures",
    aliases: ["voyage", "langues", "monde", "découverte"],
  },
  ...
  { id: "mode-style", label: "Mode & style", aliases: ["fringues", "style", "couture", "fashion"] },
  {
    ...
    aliases: ["entreprendre", "finance", "économie", "business"],
  },
  ...
  {
    id: "education-transmission",
    label: "Éducation & transmission",
    aliases: ["enseigner", "prof", "tuto", "expliquer"],
  },
  {
    id: "sante-soin",
    label: "Santé & soin",
    aliases: ["médecine", "infirmier", "santé", "bien-être"],
  },
  {
    id: "politique-societe",
    label: "Politique & société",
    aliases: ["politique", "débat", "société", "actu"],
  },
  {
    id: "bricolage-mains",
    label: "Bricolage & mains",
    aliases: ["bricoler", "menuiserie", "mécanique", "diy"],
  },
  {
    id: "communication-media",
    label: "Communication & média",
    aliases: ["média", "journalisme", "marketing", "réseaux"],
  },
  {
    id: "spiritualite-sens",
    label: "Spiritualité & sens",
    aliases: ["philo", "méditation", "religion", "sens"],
  },
] as const;
...
export const VALEURS: readonly Valeur[] = [
  {
    ...
    description: "Que les choses soient justes pour tout le monde",
  },
  {
    id: "independance",
    label: "Indépendance",
    description: "Pouvoir bosser à ton rythme, à ta façon",
  },
  { id: "securite", label: "Sécurité", description: "Un cadre stable, prévisible" },
  {
    id: "creativite",
    label: "Créativité",
    description: "Inventer, créer, faire des trucs nouveaux",
  },
  { id: "defi", label: "Défi", description: "Te dépasser, viser haut" },
  {
    id: "contact-humain",
    label: "Contact humain",
    description: "Bosser avec les gens, pour les gens",
  },
  {
    id: "reconnaissance",
    label: "Reconnaissance",
    description: "Que ton boulot soit vu et respecté",
  },
  {
    id: "argent-confort",
    label: "Argent & confort",
    description: "Bien gagner ta vie, sans culpabiliser",
  },
  { id: "apprendre", label: "Apprendre", description: "Comprendre, te former toute ta vie" },
  {
    id: "nature-vivant",
    label: "Nature & vivant",
    description: "Travailler avec / pour le vivant",
  },
  { id: "aventure", label: "Aventure", description: "Bouger, découvrir, voir du pays" },
  {
    id: "sens-utilite",
    label: "Sens & utilité",
    description: "Faire quelque chose qui sert vraiment",
  },
] as const;
