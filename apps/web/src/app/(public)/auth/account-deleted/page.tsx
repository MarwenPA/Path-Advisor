    ...
    <main className="mx-auto flex w-full max-w-md flex-col gap-6 px-4 py-12">
      <header className="flex flex-col gap-2">
        ...
        <p className="text-body text-text-muted">
          On a bien pris en compte ta demande de suppression. Tu as{" "}
          <strong>30 jours</strong> pour changer d&apos;avis.
        </p>
      </header>

      <section className="rounded-lg border border-border bg-bg-2 p-4 text-body">
        <p>
          Un email avec un lien d&apos;annulation t&apos;a été envoyé. Si tu
          ne le reçois pas dans les prochaines minutes, vérifie tes spams.
        </p>
        <p className="mt-3 text-body-sm text-text-muted">
          Passé les 30 jours, tes données seront effacées définitivement (sauf
          le journal d&apos;audit pseudonymisé, conservé 3 ans pour des
          raisons légales).
        </p>
      </section>
