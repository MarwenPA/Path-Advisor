    ...
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-4 py-12">
      <header className="flex flex-col gap-2">
        ...
        <p className="text-body text-text-muted">
          Tes données t&apos;appartiennent. Tu peux les récupérer à tout moment
          dans un format standard, ou demander leur suppression complète.
        </p>
      </header>
      ...
      <section className="flex flex-col gap-3 rounded-lg border border-border bg-bg p-6">
        ...
        <p className="text-body text-text-muted">
          Conformément à l&apos;Article 20 du RGPD (droit à la portabilité), tu
          peux télécharger l&apos;intégralité des données que Path-Advisor
          détient sur toi, dans un format structuré et machine-readable.
        </p>
        <div className="flex flex-col gap-2 md:flex-row md:items-center">
          <Button asChild>
            <Link href="/parametres/confidentialite/mes-donnees">
              Gérer mes exports RGPD
            </Link>
          </Button>
          <p className="text-xs text-text-subtle">
            Tu peux lancer un export par 24 heures. L&apos;archive reste
            téléchargeable 7 jours après sa génération.
          </p>
        </div>
      </section>
      ...
      <section className="rounded-lg border border-dashed border-border-strong bg-bg-2 p-6">
        ...
        <p className="text-body text-text-muted">
          Le droit à l&apos;oubli RGPD sera disponible dans une prochaine étape
          (Story 1.12). En attendant, écris à{" "}
