    ...
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-4 py-12">
      <header className="flex flex-col gap-2">
        ...
        <p className="text-body text-text-muted">
          Exerce ton droit à la portabilité RGPD. L&apos;archive contient ton profil,
          l&apos;historique des accès à tes données, et toutes les autres données que Path-Advisor
          détient sur toi.
        </p>
      </header>
      ...
      <aside className="rounded-lg border border-border bg-bg-2 p-4 text-sm text-text-muted">
        ...
        <ul className="mt-2 list-inside list-disc space-y-1">
          <li>
            L&apos;archive est chiffrée en AES-256 ; tu reçois le mot de passe dans un email{" "}
            <strong>séparé</strong> du lien.
          </li>
          <li>
            Pour ouvrir l&apos;archive : 7-Zip (Windows), Keka (Mac), p7zip (Linux). Le ZIP natif
            Windows ne sait pas lire l&apos;AES-256.
          </li>
          <li>
            Le lien est valable 7 jours, et tu peux télécharger l&apos;archive jusqu&apos;à 10 fois.
          </li>
          <li>
            Si tu perds le mot de passe, nous ne pouvons pas te le redonner — relance un nouvel
            export pour en obtenir un autre.
          </li>
        </ul>
      </aside>
