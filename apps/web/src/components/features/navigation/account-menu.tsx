...
import { MVP_FALLBACK_PATH } from "@/lib/auth/post-login-redirect";
...
export function AccountMenu({ email, variant = "sidebar" }: AccountMenuProps) {
  ...
  async function handleLogout() {
    ...
    try {
      ...
      // Code-review note (anticipated): a network failure on logout must not
      // trap the user on a page they believe they've left — the session
      // cookie will expire server-side regardless. Redirect unconditionally.
    }
