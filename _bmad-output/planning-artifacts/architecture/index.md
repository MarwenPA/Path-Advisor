...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Options évaluées](./starter-template-evaluation.md#options-values)
    - [Stack retenue : Django 5 + DRF + Next.js + FastAPI (AI service)](./starter-template-evaluation.md#stack-retenue-django-5-drf-nextjs-fastapi-ai-service)
    - [Structure de projet recommandée](./starter-template-evaluation.md#structure-de-projet-recommande)
    - [Commandes d'initialisation](./starter-template-evaluation.md#commandes-dinitialisation)
    - [Architectural Decisions Provided by Starter](./starter-template-evaluation.md#architectural-decisions-provided-by-starter)
    - [Briques explicitement ajoutées au-delà du starter](./starter-template-evaluation.md#briques-explicitement-ajoutes-au-del-du-starter)
    - [Service IA Python — briques](./starter-template-evaluation.md#service-ia-python-briques)
